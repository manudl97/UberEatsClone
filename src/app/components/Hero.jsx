  ...
  return (
    <div className='max-w-[1640px] max-auto p-4'>
        <div className='max-h-[500px] relative'>
            ...
            <img className='w-full max-h-[500px] object-cover' src="https://images.pexels.com/photos/5908060/pexels-photo-5908060.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="/" />
        </div>
    </div>
  )
}
